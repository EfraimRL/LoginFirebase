...
#import "DataBase.h"
#import <sqlite3.h>
#define DATABASE_NAME @"ruta.sqlite"
...
{
	BOOL success;
    //[class Metodo] equivale a class.metodo
    //[class propiedad] equivale a class.metodo
    //Class *nombreObjeto = [Class initwith...]
