...
class platosTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        for index in 1...11 {
            array.append(["idc":"\(index)","nomc":"numero \(index)"])
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let id = array[indexPath.row]["idc"]
        let nombre = array[indexPath.row]["nomc"]
        cell.txtCelda1.text = id
        cell.descripcion.text = nombre
        return cell
    }
